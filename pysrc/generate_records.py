...
table = ddb.Table('responses-prod')
...
location_ids = ['b55cc05-35d-b73d-656c-71fff2807d16']
subloc_ids = {
    'b55cc05-35d-b73d-656c-71fff2807d16': [
        'f4b60-036d-af03-06a8-4f7cb5e323cd',
        'c37a076-25c4-140a-f07b-c4b53a40b1e1',
        '706415f-d0f-2b54-7c1-e723e5531'
    ]
}
...
for i in range(0, 100):
    ...
    timestamp = datetime.datetime(2020, mon, random.choice(days[mon]), random.choice(hours), random.choice(minutes), random.choice(minutes)).strftime("%a %b %d %Y %X")
    table.put_item(
        Item={
            'id': str(uuid.uuid4()),
            'age': str(random.choice(age)),
