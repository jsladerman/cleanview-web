        ...
        return (
            <div className={styles.qrManagementBlock}>
                <div className="container-fluid text-wrap" id={styles.qrManagementContainer}>
                    ...
                    <Row>
                        <Col>
                            <AddNewSublocation sublocations={this.state.sublocations}
                                               handleSubmit={this.addSublocation}/>
                        </Col>
                        <Col>
                        ...
                        <Col>
                            <RecoverSublocation sublocations={this.state.sublocations}
                                                handleSubmit={this.recoverSublocation}/>
                        </Col>
                    </Row>
                    {sublocationtable()}
